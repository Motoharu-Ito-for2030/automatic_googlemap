...
options.add_argument(
    '--user-data-dir=C:\\Users\\sketd\\AppData\\Local\\Google\\Chrome\\User Data')

# この行を省略するとDefaultフォルダが指定されます
options.add_argument('--profile-directory=Default')

# driver = webdriver.Chrome(options=options)
driver = webdriver.Chrome(
    executable_path='C:\\Users\\sketd\\TECH.I.S\\Python\\MyPandas\\chromedriver.exe', options=options, )
